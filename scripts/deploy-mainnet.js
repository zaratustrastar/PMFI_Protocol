...
async function main() {
  ...
  console.log("Using Base Mainnet USDC:", USDC_ADDRESS);
  ...
  const mockStrategy = await MockSniperStrategy.deploy(USDC_ADDRESS, hre.ethers.ZeroAddress);
  ...
  // Set keeper to deployer (for testing)
